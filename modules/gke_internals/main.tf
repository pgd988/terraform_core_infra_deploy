resource "kubernetes_namespace" "app_ns" {
  count = var.enable_internals ? 1 : 0
...
resource "kubernetes_namespace" "argocd_ns" {
  count = var.enable_internals && var.enable_argocd ? 1 : 0
...
resource "kubernetes_secret" "argocd_repo_creds" {
  count = var.enable_internals && var.enable_argocd && var.argocd_ssh_key_ready ? 1 : 0
